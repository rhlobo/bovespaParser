...
from . import parsingutils as util
...
VISTA, EXERCICIO_OPCAO_COMPRA, EXERCICIO_OPCAO_VENDA, LEILAO, FRACIONARIO, TERMO, OPCAO_COMPRA, OPCAO_VENDA, TODOS = ['010', '012', '013', '017', '020', '030', '070', '080', None]


def parsedata(data, opts=[CODNEG, DATA, PREABE, PREMIN, PREMAX, PREULT, QUATOT], market=VISTA):
    return [[opt.parse(line) for opt in opts] for line in data if TIPREG.parse(line) == '01' and (market is None or TPMERC.parse(line) == market)]
